"""
Silver Bullet (London) Strategy Adapter
...
class SilverBulletLondonAdapter(BaseAdapter):
    """
    Adapter for Silver Bullet (London) strategy.

    Strategy specifics:
    - Time constraint: 03:00-04:00 NY
    ...
    def get_strategy_id(self) -> str:
        return "silver_bullet_london"

    def validate_config(self, config: Any) -> bool:
        """Validate Silver Bullet London config has required attributes."""
        required_attrs = [
            'tp1_r', 'tp1_close_pct',
            'tp2_r', 'tp2_close_pct',
